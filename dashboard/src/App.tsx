    ...
    <div className="flex h-screen overflow-hidden" style={{ background: '#07101F' }}>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-hidden" style={{ background: '#07101F' }}>
          {visited.has('intelligence')  && <div className={clsx('h-full overflow-y-auto', active !== 'intelligence'  && 'hidden')} style={{ background: '#07101F' }}><IntelligenceTab onGoToConfig={() => setActive('config')} /></div>}
          {visited.has('deep-dive')     && <div className={clsx('h-full overflow-y-auto', active !== 'deep-dive'     && 'hidden')} style={{ background: '#07101F' }}><div className="content"><DeepDiveTab /></div></div>}
